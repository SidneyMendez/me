...
def stubborn_asker(low, high):
    ...
    """
    message = "Give number between {low}, and {high}: ".format(low=low, high=high)
    ...
    while True:
        ...
        # if 30 < inpur number < high 
            print("The number {} is correct".format(input_number))
            return input_number
...
def not_number_rejector(message):
    ...
    while True:
        try:
            ...
            print("thanks, {} is a number.".format(input_number))
        except ValueError:
            print("nah, thats not a number.")
        return input_number
